...
function Close(){
    ...
    document.getElementById("pr1").style.width="16%";
    document.getElementById("pr1").style.height="16%";
    document.getElementById("pr1").style.margin="2px 0px 0px 30px";
...
function  Resumefn(){
    ...
    if(x.matches && y.matches){
        ...
        document.getElementById("bodyi").style.position="relative";
        document.getElementById("bodyi").style.width="auto";
        document.getElementById("cutitr").style.display="block"; 
        document.getElementById("bodyi").style.overflow="hidden";
        document.getElementById("bodyi").style.backgroundColor="rgb(8, 17, 48)";
        document.getElementById("bodyi").style.backgroundSize="cover";
        document.getElementById("main1").style.display="none";
        document.getElementById("Menuresume").style.display="none"
        
        document.getElementById("test").style.display="block"
        document.getElementById("test").style.backgroundColor="rgb(8, 17, 48)"
        document.getElementById("Sidebar").style.transition="0.4s";
        document.getElementById("Sidebar").style.width="0px";
...
function Open2(){
    ...
    document.getElementById("R1").style.width="0px"; 
    ...
    document.getElementById("Menuresume").style.display="block";
...
function Open3(){
   ...
   document.getElementById("mainenter").style.display="block";
